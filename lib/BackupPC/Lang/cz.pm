...
<ul>
<li> \$fullTot úplnıch záloh v celkové velitosti \${fullSizeTot}GB
     (pøed kompresí),
...
<tr class="tableheader"><td> Host </td>
    ...
    <td align="center"> Plnı Velikost (GB) </td>
...
# -----------------------------------
$Lang{Pool_Stat} = <<EOF;
        <li>V úloišti je \${poolSize}GB zahrnujíc \$info->{"\${name}FileCnt"} souborù
...
$Lang{Status_link_running} = "link bìí";
